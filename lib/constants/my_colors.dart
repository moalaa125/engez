...
class MyColors {
  ...
  static const Color myDarkText = Color(0xFF3A1B0D);
  static const Color mySuccess = Color(0xFF1B8354);
  static const Color myError = Color(0xFFD32F2F);
  static const Color myWarning = Color(0xFFF5A623);
  static const Color myBackgroundAlt = Color(0xFFFFF1E9);
  static const Color myTextSecondary = Color(0xFF8A7A73);
  static const Color myBorder = Color(0xFFEFE3DC);
}
